...
(apps_aov = aov(Rating~Size+Installs+Price+Reviews+Genres+`Content Rating`+`Last Updated`, data = apps2))

summary(apps_aov)

```

##Graphing the relationship between the rating and installs
```{r}
appplot <- ggplot(apps2, aes(Installs,Rating,color = Genres))+geom_point()
